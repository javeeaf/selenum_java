package org.seleniumhq.selenium.selenium_java2;
	...
	public class ExcelRead {
		...
		String filepath = "C:\\Users\\admin\\eclipse-workspace\\javee\\src\\javee\\input\\outputfile.xls";
		private HSSFWorkbook inputworkbook;
		public void ReadData(String sheetName) throws IOException
		{
			FileInputStream FI = new FileInputStream(filepath);
			inputworkbook = new HSSFWorkbook(FI);
